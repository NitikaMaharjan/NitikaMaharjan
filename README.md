...
[![Tech Stack](https://skillicons.dev/icons?i=javascript,typescript,react,next,tailwind,php,python,nodejs,expressjs,mysql,mongodb,git,figma)](https://skillicons.dev)
